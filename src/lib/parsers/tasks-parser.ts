/**
 * Tasks parser for docs/tasks/ markdown files with YAML frontmatter
 * Implements ISourceParser interface
 */
...
export class TasksParser implements ISourceParser {
  readonly sourceType: SourceType = 'tasks';
   ...
   */
  private getStatusFromPath(filepath: string): TaskStatus {
